        ...
        <div class="container">
            ...
            <div class="card mb-4 card-design">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('gis.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Name <span class="mendatory">*</span></label>
                            <div class="col-sm-10">
