                    ...
                    <form method="POST" action="{{ route('report.update', $report->id) }}" enctype="multipart/form-data">
                                ...
                                <select name="fm_category_id" id="category"
                                    ...
                                    <optgroup>
                                        ...
                                        @foreach ($categories as $item)
                                            <option value="{{ $item->id }}" @if ($item->id == $report->fm_category_id)
                                                {{ 'selected= "selected" ' }}
                                        @endif
                                        >{{ $item->title }}</option>
                                        @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group datepicker-box">
                                    <input name="date" class="form-control datepicker w-100" value="{{ $report->date }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9" id="file_group">
                                @php
                                $fileName = explode('-',$report->file_path);
                                @endphp
                        ...
                        <div class="pull-right">
                            <a href="{{ route('manage') }}" id="submit" class="btn btn-warning">Cancel</a>
