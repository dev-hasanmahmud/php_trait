    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pt-1">
        <div class="procurement-title">
          <h5 class="d-inline">
            <i class="fa fa-bar-chart" aria-hidden="true"></i> Procurement Method
          </h5>                
        </div>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
        <a class=" btn sub-btn float-right" href="{{ route('procurement_method.create') }}" ><i class="fa fa-plus"> </i> Add Procurement Method</a>
...
<div class="main-content mt-4 ">
  <div class="container">
    ...
    <section class="package-table card card-body">
            ...
            <table class="table table-bordered table-striped">
                <thead>
                  <tr class="text-center">
                    ...
                    <th scope="col">Name In Bangli</th>
                    <th scope="col">Procurement Method Type</th>
                    <th scope="col" class="text-center">Action</th>
                  </tr>
                </thead>
                <tbody>
                    @foreach ($proc_method as $item)
                    <tr>
                        ...
                        <td class="text-center">
                          <a class="edit-service-type-modal btn btn-warning btn-xs" href="{{route('procurement_method.edit',$item->id)}}" title="Edit"><i class="fa fa-edit"></i></a> 
        ...
        <div class="mt-4 text-center">{{ $proc_method->links() }}</div>
    </section>
  </div>
    ...
    $('body').on('click', '#delete-user', function () {
        ...
        swal({
            ...
            if (value) {
              ...
              $.ajax({
                type: "DELETE",
                url: " {{ url('procurement_method') }}"+'/'+method_id,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
                    console.log(data)
                    swal("Deleted!", "Your imaginary file has been deleted.", "success");
                    window.location.assign("/procurement_method")
                },
                error: function (data) {
