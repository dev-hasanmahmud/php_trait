            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pt-1">
                    <div class="procurement-title">
                        <h5 class="d-inline">
                            <i class="fa fa-usd" aria-hidden="true"></i> Add Source Fund
                        </h5>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <a class="active btn sub-btn float-right" href="{{ route('source_of_fund.create') }}"><i
        ...
        <div class="container">
            ...
            <div class="card mb-4 card-design">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('source_of_fund.store') }}">
                        @csrf
                        <div class="border p-3 bg-white rounded">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" required="" class="form-control"
                                    id="source_of_fund_name_en" aria-describedby="textHelp" />
                                {{-- <small id="emailHelp" class="form-text text-danger">We'll
                            ...
                            <div class="form-group">
                                ...
                                isset($source->type_id) ? json_decode($source->type_id) : null), ['multiple' => 'multiple',
                                'class' => 'form-control custom-select select2 full-width', 'data-init-plugin' => 'select2',
