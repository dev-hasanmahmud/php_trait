            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pt-1">
                    <div class="procurement-title">
                        <h5 class="d-inline">
                            <i class="fa fa-user" aria-hidden="true"></i> Add File Manager Category
                        </h5>
                    </div>
                </div>
            ...
            <div class="card mb-4 card-design">
                <div class="card-body">
                    <div class="card-title bg-primary text-white">
                        <h5>Add File Manager Category </h5>
                    </div>
                    @include('sweetalert::alert')


                    <form action="{{ route('file-manager-category.store') }}" method="post">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="name_en" required />
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="checkbox" class="form-check-input" id="is_sub_category">
