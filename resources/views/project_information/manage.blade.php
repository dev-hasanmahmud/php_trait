            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <a class=" btn sub-btn float-right"
                        href='{{ url('dashboard/emcrp-project-information-dphe/create', $mainCategory->id) }}'><i
                            ...
                            <tbody>
                                @foreach ($files as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form class="delete" action="{{ route('project_info.delete', $item->id) }}"
                                                method="POST">
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <a class="btn btn-info btn-sm  fa fa-edit "
                                                    href="{{ route('project_info.edit', $item->id) }}" title="Edit"></a>
