            ...
            <div class="card mb-4 card-design">
                <div class="card-body">
                    <div class="card-title bg-primary text-white">
                        <h5>Add New {{ $mainCategory->title }} Report</h5>
                    </div>
                    <form method="POST" action="{{ route('project_info.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        {{-- <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Select Package</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Select Category <span
                                    class="mendatory">*</span></label>
                            <div class="col-sm-10">
                                <select name="fm_category_id" id="fm_category_id" required=""
                                    class="form-control form-control-sm select2 custom-select2">
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Report Name <span
                                    class="mendatory">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-lg btn-warning"
                                href="{{ route('project_info.subCategory', $mainCategory->id) }}">Cancel</a>
                            <button type="submit" id="submit" class="btn btn-lg btn-primary">Submit</button>
                        </div>
                        <input type="text" hidden="" name="parent_id" value="{{ $mainCategory->id }}">
                    </form>
                </div>
            </div>
        </div>
