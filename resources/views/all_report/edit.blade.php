        ...
        <div class="container">
            ...
            <div class="card mb-4 card-design">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('package_Report.update', $record->id) }}"
                            ...
                            <div class="col-sm-10">
                                <select name="package" id="package"
                                    ...
                                    @foreach ($component as $item)
                                        <option value="{{ $item->id }}" @if ($item->id == $record->table_id)
                                            {{ 'selected= "selected" ' }}
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Select Category <span class="mendatory">*</span> </label></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Report Name <span class="mendatory">*</span> </label></label>
                            <div class="col-sm-10">
