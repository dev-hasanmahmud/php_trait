        ...
        <div class="container">
            <div class="card mb-4 card-design">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('package_Report.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#package').change(function() {
                ...
                console.log('package_id from component tabel = ' + package_id);

                var url = " {{ url('ajax/get_category_by_package_id') }}" + '/' + package_id;
                $.ajax({
                    method: 'GET',
                    url: url,
                    //data:{'id':package_id},
